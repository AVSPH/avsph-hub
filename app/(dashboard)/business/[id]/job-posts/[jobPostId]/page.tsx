...
function KanbanColumn({ stage, applicants, onCardClick }: KanbanColumnProps) {
  ...
  return (
    <div
      ref={columnRef}
      className={`flex flex-col rounded-lg border bg-muted/30 min-w-[280px] w-[280px] shrink-0 border-t-2 transition-colors ${
        stageTypeStyles[stage.type] || "border-t-border"
